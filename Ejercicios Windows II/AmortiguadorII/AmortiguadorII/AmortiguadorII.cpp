...
// AmortiguadorII.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAmortiguadorIIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAmortiguadorIIApp

CAmortiguadorIIApp::CAmortiguadorIIApp()
{
...
// El único objeto CAmortiguadorIIApp

CAmortiguadorIIApp theApp;


// Inicialización de CAmortiguadorIIApp

BOOL CAmortiguadorIIApp::InitInstance()
{
