...
// Controladores de mensaje de CSenoDlg

BOOL CSenoDlg::OnInitDialog()
{
...
void CSenoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSenoDlg::OnQueryDragIcon()
{
