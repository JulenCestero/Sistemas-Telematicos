...
// Seno.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CSenoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CSenoApp
...
// El único objeto CSenoApp

CSenoApp theApp;


// Inicialización de CSenoApp

BOOL CSenoApp::InitInstance()
{
