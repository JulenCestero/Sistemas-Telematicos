...
// AmortiguadorIII.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAmortiguadorIIIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAmortiguadorIIIApp

CAmortiguadorIIIApp::CAmortiguadorIIIApp()
{
...
// El único objeto CAmortiguadorIIIApp

CAmortiguadorIIIApp theApp;


// Inicialización de CAmortiguadorIIIApp

BOOL CAmortiguadorIIIApp::InitInstance()
{
