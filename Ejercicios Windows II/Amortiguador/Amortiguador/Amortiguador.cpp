...
// Amortiguador.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CAmortiguadorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CAmortiguadorApp

CAmortiguadorApp::CAmortiguadorApp()
{
...
// El único objeto CAmortiguadorApp

CAmortiguadorApp theApp;


// Inicialización de CAmortiguadorApp

BOOL CAmortiguadorApp::InitInstance()
{
