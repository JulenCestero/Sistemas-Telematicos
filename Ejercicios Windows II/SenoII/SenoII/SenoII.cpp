...
// SenoII.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CSenoIIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CSenoIIApp

CSenoIIApp::CSenoIIApp()
{
...
// El único objeto CSenoIIApp

CSenoIIApp theApp;


// Inicialización de CSenoIIApp

BOOL CSenoIIApp::InitInstance()
{
