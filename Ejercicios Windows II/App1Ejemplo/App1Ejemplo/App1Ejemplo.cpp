...
// App1Ejemplo.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CApp1EjemploApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CApp1EjemploApp

CApp1EjemploApp::CApp1EjemploApp()
{
...
// El único objeto CApp1EjemploApp

CApp1EjemploApp theApp;


// Inicialización de CApp1EjemploApp

BOOL CApp1EjemploApp::InitInstance()
{
