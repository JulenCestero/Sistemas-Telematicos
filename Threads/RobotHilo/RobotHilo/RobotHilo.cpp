...
// RobotHilo.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CRobotHiloApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CRobotHiloApp

CRobotHiloApp::CRobotHiloApp()
{
...
// El único objeto CRobotHiloApp

CRobotHiloApp theApp;


// Inicialización de CRobotHiloApp

BOOL CRobotHiloApp::InitInstance()
{
