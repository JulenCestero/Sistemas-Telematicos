...
// EntregableSensores.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CEntregableSensoresApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CEntregableSensoresApp

CEntregableSensoresApp::CEntregableSensoresApp()
{
...
// El único objeto CEntregableSensoresApp

CEntregableSensoresApp theApp;


// Inicialización de CEntregableSensoresApp

BOOL CEntregableSensoresApp::InitInstance()
{
