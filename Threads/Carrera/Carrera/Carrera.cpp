...
// Carrera.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CCarreraApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CCarreraApp

CCarreraApp::CCarreraApp()
{
...
// El único objeto CCarreraApp

CCarreraApp theApp;


// Inicialización de CCarreraApp

BOOL CCarreraApp::InitInstance()
{
