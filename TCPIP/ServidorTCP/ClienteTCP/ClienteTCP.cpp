...
// ClienteTCP.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CClienteTCPApp
...
// El único objeto CClienteTCPApp

CClienteTCPApp theApp;


// Inicialización de CClienteTCPApp
