...
// ServidorTCP.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CServidorTCPApp
...
// El único objeto CServidorTCPApp

CServidorTCPApp theApp;


// Inicialización de CServidorTCPApp
