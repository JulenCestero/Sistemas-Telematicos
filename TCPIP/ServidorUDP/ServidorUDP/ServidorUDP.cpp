...
// ServidorUDP.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CServidorUDPApp
...
// El único objeto CServidorUDPApp

CServidorUDPApp theApp;


// Inicialización de CServidorUDPApp
