...
// ClienteUDP.cpp : define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CClienteUDPApp
...
// El único objeto CClienteUDPApp

CClienteUDPApp theApp;


// Inicialización de CClienteUDPApp
