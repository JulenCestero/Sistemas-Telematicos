...
// Servidor.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CServidorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CServidorApp

CServidorApp::CServidorApp()
{
...
// El único objeto CServidorApp

CServidorApp theApp;


// Inicialización de CServidorApp

BOOL CServidorApp::InitInstance()
{
