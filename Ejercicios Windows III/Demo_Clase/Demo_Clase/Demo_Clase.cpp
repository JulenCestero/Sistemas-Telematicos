...
// Demo_Clase.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CDemo_ClaseApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CDemo_ClaseApp

CDemo_ClaseApp::CDemo_ClaseApp()
{
...
// El único objeto CDemo_ClaseApp

CDemo_ClaseApp theApp;


// Inicialización de CDemo_ClaseApp

BOOL CDemo_ClaseApp::InitInstance()
{
