...
// Controles_usuario.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CControles_usuarioApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CControles_usuarioApp

CControles_usuarioApp::CControles_usuarioApp()
{
...
// El único objeto CControles_usuarioApp

CControles_usuarioApp theApp;


// Inicialización de CControles_usuarioApp

BOOL CControles_usuarioApp::InitInstance()
{
