...
// Semaforo.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CSemaforoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CSemaforoApp

CSemaforoApp::CSemaforoApp()
{
...
// El único objeto CSemaforoApp

CSemaforoApp theApp;


// Inicialización de CSemaforoApp

BOOL CSemaforoApp::InitInstance()
{
